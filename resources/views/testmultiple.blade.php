                                    ...
                                    <div class="card-sigin">
                                        ...
                                        <div class="card-sigin">
                                            <div class="main-signup-header">
                                                ...
                                                <form method="POST" action="{{ route('testmultiple') }}">
                                                    @csrf
                                                    <div id="selections-container">
                                                        <div class="selection-row">
                                                            <select name="selected_option[]" onchange="toggleInput(this)">
