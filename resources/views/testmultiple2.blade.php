                                            ...
                                            <div class="main-signup-header">
                                                ...
                                                <form method="POST" action="">
                                                    ...
                                                    <div class="selection-row">
                                                        ...
                                                        @foreach($data as $dat)
                                                            @php $i=0;@endphp
                                                        <select name="selected_option" id="selected_option" onchange="toggleInput(this)">
                                                        
                                                            <option value="option1" {{ $dat[$i]['selected_option'] === 'option1' ? 'selected' : '' }}>Option 1</option>
                                                            <option value="option2" {{ $dat[$i]['selected_option'] === 'option2' ? 'selected' : '' }}>Option 2</option>
                                                            <!-- Add more options as needed -->
                                                            
                                                        </select>

                                                        <label for="input_value">Input Value:</label>
                                                        <input type="text" name="input_value" id="input_value" value="{{ $dat[$i]['input_value'] }}">
                                                        @php $i++;@endphp
                                                            @endforeach
                                                    </div>
